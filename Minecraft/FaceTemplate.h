...
namespace FaceTemplate
{
	namespace FullBlock
	{
		static inline void fillNorth(std::vector<Engine::MinecraftVertex> &v, const size_t nIndexOffset, std::vector<uint32_t> &i, const Engine::vu3d offset, const uint32_t nIndex) noexcept
		{
			i.push_back(nIndexOffset + v.size() + 0);
			i.push_back(nIndexOffset + v.size() + 1);
			i.push_back(nIndexOffset + v.size() + 2);
			i.push_back(nIndexOffset + v.size() + 1);
			i.push_back(nIndexOffset + v.size() + 3);
			i.push_back(nIndexOffset + v.size() + 2);
		...
		static inline void fillSouth(std::vector<Engine::MinecraftVertex> &v, const size_t nIndexOffset, std::vector<uint32_t> &i, const Engine::vu3d offset, const uint32_t nIndex) noexcept
		{
			i.push_back(nIndexOffset + v.size() + 0);
			i.push_back(nIndexOffset + v.size() + 1);
			i.push_back(nIndexOffset + v.size() + 2);
		...
		static inline void fillEast(std::vector<Engine::MinecraftVertex> &v, const size_t nIndexOffset, std::vector<uint32_t> &i, const Engine::vu3d offset, const uint32_t nIndex) noexcept
		{
			i.push_back(nIndexOffset + v.size() + 0);
			i.push_back(nIndexOffset + v.size() + 1);
			i.push_back(nIndexOffset + v.size() + 2);
		...
		static inline void fillWest(std::vector<Engine::MinecraftVertex> &v, const size_t nIndexOffset, std::vector<uint32_t> &i, const Engine::vu3d offset, const uint32_t nIndex) noexcept
		{
			i.push_back(nIndexOffset + v.size() + 0);
			i.push_back(nIndexOffset + v.size() + 1);
			i.push_back(nIndexOffset + v.size() + 2);
		...
		static inline void fillTop(std::vector<Engine::MinecraftVertex> &v, const size_t nIndexOffset, std::vector<uint32_t> &i, const Engine::vu3d offset, const uint32_t nIndex) noexcept
		{
			i.push_back(nIndexOffset + v.size() + 0);
			i.push_back(nIndexOffset + v.size() + 1);
			i.push_back(nIndexOffset + v.size() + 2);
		...
		static inline void fillBottom(std::vector<Engine::MinecraftVertex> &v, const size_t nIndexOffset, std::vector<uint32_t> &i, const Engine::vu3d offset, const uint32_t nIndex) noexcept
		{
			i.push_back(nIndexOffset + v.size() + 0);
			i.push_back(nIndexOffset + v.size() + 1);
			i.push_back(nIndexOffset + v.size() + 2);
