...
namespace FaceTemplate
{
	namespace FullBlock
	{
		...
		static void fillNorth(std::vector<V_Type> &v, const vf3d pos, const uint32_t nSlots, const uint32_t nIndex) noexcept
		{
		...
		static void fillSouth(std::vector<V_Type> &v, const vf3d pos, const uint32_t nSlots, const uint32_t nIndex) noexcept
		{
			float fZ = (float)nIndex / (float)nSlots;
		...
		static void fillEast(std::vector<V_Type> &v, const vf3d pos, const uint32_t nSlots, const uint32_t nIndex) noexcept
		{
			float fZ = (float)nIndex / (float)nSlots;
		...
		static void fillWest(std::vector<V_Type> &v, const vf3d pos, const uint32_t nSlots, const uint32_t nIndex) noexcept
		{
			float fZ = (float)nIndex / (float)nSlots;
		...
		static void fillTop(std::vector<V_Type> &v, const vf3d pos, const uint32_t nSlots, const uint32_t nIndex) noexcept
		{
			float fZ = (float)nIndex / (float)nSlots;
		...
		static void fillBottom(std::vector<V_Type> &v, const vf3d pos, const uint32_t nSlots, const uint32_t nIndex) noexcept
		{
			float fZ = (float)nIndex / (float)nSlots;
